    ...
    <section id="contact" className="py-20 relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="mb-16 text-center animate-fade-in-down">
          ...
          <p className="text-lg text-silver-400 mt-4 max-w-3xl mx-auto font-sans animate-fade-in">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div 
            ...
            data-aos-delay="400"
          >
            <div className="glass-effect rounded-2xl p-8 border border-gold-400/20 h-full hover:scale-105 transition-all duration-300">
              <h3 className="text-3xl font-bold mb-6 text-ivory animate-fade-in-down">Our Services</h3>
              ...
              <div className="space-y-6 mb-8">
                {[
                  ...
                  >
                    <span className="text-gold-400 mr-3 animate-pulse">✦</span>
                    <span className="text-silver-300">{service}</span>
                  </div>
                ))}
              </div>
              
              <h3 className="text-2xl font-bold mb-6 text-ivory animate-fade-in-down">Our Office</h3>
              <div className="space-y-4">
                <div 
                  ...
                  data-aos-delay="1000"
                >
                  <FiPhone className="text-gold-400 mr-3 text-xl animate-bounce" />
                ...
                <div 
                  ...
                  data-aos-delay="1100"
                >
                  <FiMail className="text-gold-400 mr-3 text-xl animate-bounce" />
                  <span className="text-silver-300">Info@nextgendesignhub.com</span>
                </div>
              </div>
              
              <h3 className="text-2xl font-bold mt-8 mb-6 text-ivory animate-fade-in-down">Company</h3>
              <div className="space-y-4">
                {[
                ...
                >
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="input-gold w-full react-icon"
                ...
                >
                  ...
                  <div className="relative h-full">
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="5"
                      className="input-gold w-full h-full hover:scale-105 transition-transform duration-300"
