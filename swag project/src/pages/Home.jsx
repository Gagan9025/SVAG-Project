        ...
        <section className="py-20 relative">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <p className="text-xl text-gold-300 mt-8 max-w-3xl mx-auto font-sans">
                That drive growth, build trust, and create lasting impact.
              </p>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-6xl mx-auto">
              <div className="card-glass p-8" data-aos="fade-right">
                <h3 className="text-2xl font-bold mb-6 text-gold-400">Our Mission</h3>
                <h4 className="text-xl font-semibold mb-4 text-ivory">Empowering Business Growth Through Creative Excellence</h4>
              ...
              <div className="card-glass p-8" data-aos="fade-left">
                <h3 className="text-2xl font-bold mb-6 text-gold-400">Our Approach</h3>
                <div className="grid grid-cols-2 gap-4">
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-4 mt-10 mb-12">
              <button 
                ...
                className="px-6 py-3 rounded-full font-semibold relative overflow-hidden bg-gradient-to-r from-gold-400 to-yellow-500 text-royal-dark hover:from-yellow-500 hover:to-gold-400 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                <span className="relative z-10 font-bold">ALL SERVICES</span>
              </button>
              <button 
                onClick={() => handleServiceFilter('Digital Services')}
                className="px-6 py-3 rounded-full font-semibold relative overflow-hidden bg-gradient-to-r from-royal-blue to-indigo-700 text-ivory hover:from-indigo-700 hover:to-royal-blue transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                <span className="relative z-10 font-bold">DIGITAL SERVICES</span>
              </button>
              <button 
                onClick={() => handleServiceFilter('Print Services')}
                className="px-6 py-3 rounded-full font-semibold relative overflow-hidden bg-gradient-to-r from-purple-600 to-pink-600 text-ivory hover:from-pink-600 hover:to-purple-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                <span className="relative z-10 font-bold">PRINT SERVICES</span>
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-8">
              {services.map((service, index) => (
                <div
                  key={index}
                  className="bg-gradient-to-br from-royal-blue/30 to-royal-dark/50 backdrop-blur-sm rounded-2xl p-6 border border-gold-400/20 hover:border-gold-400/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl group"
                  data-aos="fade-up"
                  data-aos-delay={200 + index * 100}
                >
                  {/* Service Icon with enhanced styling */}
                  <div className="flex justify-center mb-6">
                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-gold-400/20 to-yellow-500/20 flex items-center justify-center text-3xl group-hover:from-gold-400/30 group-hover:to-yellow-500/30 transition-all duration-300 transform group-hover:scale-110">
                      {service.icon}
                    </div>
                  </div>
                  
                  {/* Service Title */}
                  <h3 className="text-xl font-bold mb-4 text-center text-ivory group-hover:text-gold-400 transition-colors duration-300">
                    {service.title}
                  </h3>
                  
                  {/* Service Description */}
                  <p className="text-silver-400 mb-6 text-center text-sm">
                    {service.description}
                  </p>
                  ...
                  <div className="mt-4 space-y-3">
                    {service.title === "Brand Identity Design" && (
                      <>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          ...
                          <span className="text-silver-300 text-sm">Logo Design</span>
                        </div>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">Brand Guidelines</span>
                        </div>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">Visual Identity</span>
                        </div>
                      </>
                    )}
                    {service.title === "Web & UX Development" && (
                      <>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">Web Design</span>
                        </div>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">E-commerce</span>
                        </div>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">UX/UI</span>
                        </div>
                      </>
                    )}
                    {service.title === "Digital Marketing" && (
                      <>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">SEO</span>
                        </div>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">PPC</span>
                        </div>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">Analytics</span>
                        </div>
                      </>
                    )}
                    {service.title === "Motion & Animation" && (
                      <>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">Motion Graphics</span>
                        </div>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">Video Editing</span>
                        </div>
                        <div className="flex items-center p-2 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300">
                          <span className="text-gold-400 mr-3 text-lg">✓</span>
                          <span className="text-silver-300 text-sm">Animations</span>
                        </div>
                      </>
                    )}
                  </div>
                  ...
                  <div className="mt-6 text-center">
                    <button 
                      ...
                      className="text-gold-400 font-semibold text-sm flex items-center justify-center group-hover:text-yellow-300 transition-colors duration-300"
                    >
                      View Details
              ...
              {portfolioItems.map((item, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-silver-400 text-sm mb-4">{item.description}</p>
        ...
        <section className="py-20 relative">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-silver-400 mt-2 max-w-2xl mx-auto font-sans">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="text-gold-400 text-5xl mb-4">❝</div>
                  <p className="text-silver-300 mb-6 italic">"{testimonial.quote}"</p>
                  <div className="border-t border-gold-400/20 pt-4">
                    <h4 className="text-lg font-bold text-ivory">{testimonial.author}</h4>
        ...
        <section className="py-20 relative">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h3 className="text-2xl md:text-3xl font-bold mb-6 text-ivory" data-aos="fade-up" data-aos-delay="100">
                Ready to Elevate Your Brand?
              </h3>
              <p className="text-xl text-gold-300 mt-4 mb-8 max-w-2xl mx-auto font-sans" data-aos="fade-up" data-aos-delay="200">
            ...
            <div className="mt-20 max-w-6xl mx-auto">
              <h3 className="text-2xl md:text-3xl font-bold text-center mb-12 text-gold-400" data-aos="fade-up">
                Our Comprehensive Services
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="card-glass p-6" data-aos="fade-up" data-aos-delay="100">
                  <h4 className="text-xl font-bold mb-4 text-ivory">Digital Consulting</h4>
                ...
                <div className="card-glass p-6" data-aos="fade-up" data-aos-delay="200">
                  <h4 className="text-xl font-bold mb-4 text-ivory">Digital Marketing</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center text-silver-300">
                ...
                <div className="card-glass p-6" data-aos="fade-up" data-aos-delay="300">
                  <h4 className="text-xl font-bold mb-4 text-ivory">Web Development</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center text-silver-300">
                ...
                <div className="card-glass p-6" data-aos="fade-up" data-aos-delay="400">
                  <h4 className="text-xl font-bold mb-4 text-ivory">Graphic & Video</h4>
                  <ul className="space-y-2">
                    <li className="flex items-center text-silver-300">
