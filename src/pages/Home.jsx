      ...
      <main className="flex-grow">
        ...
        <section className="py-16 mobile:section-py relative mobile-page-section">
          ...
          <div className="container mx-auto px-4 mobile:px-0 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mobile:gap-6 max-w-6xl mx-auto">
              <div className="card-glass p-6 mobile:p-5 mobile:content-block touch:card-enhanced" data-aos="fade-right">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-4">
                  {['Strategic Design Thinking', 'Data-Driven Solutions', 'Innovation at Core', 'Business Strategy'].map((item, index) => (
                    <div key={index} className="flex items-center touch:p-3" data-aos="fade-up" data-aos-delay={100 * index}>
                      <span className="text-gold-400 mr-2 touch:text-lg">✦</span>
                      <span className="text-silver-300 text-sm mobile:text-base touch:text-base">{item}</span>
                    </div>
                  ))}
                </div>
              </div>
              
              <div className="card-glass p-6 mobile:p-5 mobile:content-block touch:card-enhanced" data-aos="fade-left">
        ...
        <section className="py-16 mobile:section-py relative mobile-page-section">
          ...
          <div className="container mx-auto px-4 mobile:px-0 relative z-10">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-8 mb-10 mobile:gap-3">
              <button 
                onClick={() => handleServiceFilter('All Services')}
                className="px-5 py-2.5 mobile:px-4 mobile:py-3 rounded-full font-semibold relative overflow-hidden bg-gradient-to-r from-gold-400 to-yellow-500 text-royal-dark hover:from-yellow-500 hover:to-gold-400 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl touch:active-scale-md touch:min-h-12 touch:min-w-12 touch:p-4 touch:btn-enhanced"
              >
              ...
              <button 
                ...
                className="px-5 py-2.5 mobile:px-4 mobile:py-3 rounded-full font-semibold relative overflow-hidden bg-gradient-to-r from-royal-blue to-indigo-700 text-ivory hover:from-indigo-700 hover:to-royal-blue transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl touch:active-scale-md touch:min-h-12 touch:min-w-12 touch:p-4 touch:btn-enhanced"
              >
              ...
              <button 
                ...
                className="px-5 py-2.5 mobile:px-4 mobile:py-3 rounded-full font-semibold relative overflow-hidden bg-gradient-to-r from-purple-600 to-pink-600 text-ivory hover:from-pink-600 hover:to-purple-600 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl touch:active-scale-md touch:min-h-12 touch:min-w-12 touch:p-4 touch:btn-enhanced"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mobile:gap-4 mt-6">
              {services.map((service, index) => (
                <div
                  key={index}
                  className="bg-gradient-to-br from-royal-blue/30 to-royal-dark/50 backdrop-blur-sm rounded-2xl p-5 mobile:p-4 border border-gold-400/20 hover:border-gold-400/50 transition-all duration-300 hover:scale-105 hover:shadow-2xl group touch:active-scale-md touch:card-enhanced"
                  data-aos="fade-up"
                  data-aos-delay={200 + index * 100}
                >
                  {/* Service Icon with enhanced styling */}
                  <div className="flex justify-center mb-5">
                    <div className="w-16 h-16 mobile:w-14 mobile:h-14 rounded-full bg-gradient-to-br from-gold-400/20 to-yellow-500/20 flex items-center justify-center text-2xl mobile:text-xl group-hover:from-gold-400/30 group-hover:to-yellow-500/30 transition-all duration-300 transform group-hover:scale-110 touch:text-3xl">
                      {service.icon}
                    </div>
                  </div>
                  
                  {/* Service Title */}
                  <h3 className="text-lg mobile:text-xl font-bold mb-3 text-center text-ivory group-hover:text-gold-400 transition-colors duration-300 touch:text-2xl">
                    {service.title}
                  </h3>
                  
                  {/* Service Description */}
                  <p className="text-silver-400 mb-5 text-center text-xs mobile:text-sm touch:text-base">
                    {service.description}
                  </p>
                  ...
                  <div className="mt-4 space-y-2">
                    {service.title === "Brand Identity Design" && (
                      <>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">Logo Design</span>
                        </div>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">Brand Guidelines</span>
                        </div>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">Visual Identity</span>
                        </div>
                      </>
                    )}
                    {service.title === "Web & UX Development" && (
                      <>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">Web Design</span>
                        </div>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">E-commerce</span>
                        </div>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">UX/UI</span>
                        </div>
                      </>
                    )}
                    {service.title === "Digital Marketing" && (
                      <>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">SEO</span>
                        </div>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">PPC</span>
                        </div>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">Analytics</span>
                        </div>
                      </>
                    )}
                    {service.title === "Motion & Animation" && (
                      <>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">Motion Graphics</span>
                        </div>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">Video Editing</span>
                        </div>
                        <div className="flex items-center p-3 bg-royal-dark/30 rounded-lg hover:bg-royal-dark/50 transition-colors duration-300 touch:p-4">
                          <span className="text-gold-400 mr-2 text-lg touch:text-xl">✓</span>
                          <span className="text-silver-300 text-xs mobile:text-sm touch:text-base">Animations</span>
                        </div>
                      </>
                    )}
                  </div>
                  ...
                  <div className="mt-5 text-center">
                    <button 
                      ...
                      className="text-gold-400 font-semibold text-sm flex items-center justify-center group-hover:text-yellow-300 transition-colors duration-300 touch:text-base touch:p-3"
                    >
                      View Details
                      <svg xmlns="http://www.w3.org/2000/svg" className="ml-2 group-hover:translate-x-1 transition-transform duration-300 touch:text-lg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="container mx-auto px-4 mobile:px-0 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mobile:gap-4">
              {portfolioItems.map((item, index) => (
                <div 
                  key={index}
                  className="card-glass overflow-hidden hover:scale-105 transition-all duration-300 touch:active-scale-md touch:card-enhanced"
                  data-aos="fade-up"
                >
                  <div className="relative">
                    <img 
                      src={item.image} 
                      alt={item.title} 
                      className="w-full h-48 mobile:h-40 object-cover touch:h-44"
                    />
                    <div className="absolute top-3 right-3 bg-gold-400 text-royal-dark px-2.5 py-1 rounded-full text-xs font-semibold touch:text-sm">
                      {item.category}
                    </div>
                  </div>
                  <div className="p-5 mobile:p-4">
                    <h3 className="text-lg mobile:text-xl font-bold mb-2 text-ivory touch:text-2xl">{item.title}</h3>
                    <p className="text-silver-400 text-sm mobile:text-xs mb-4 touch:text-base">{item.description}</p>
                    <div className="flex justify-between text-xs mobile:text-xs touch:text-sm">
            ...
            <div className="text-center mt-10">
              <button className="btn-royal-gold px-6 py-3 mobile:btn-full text-lg hover:scale-105 transition-transform duration-300 touch:active-scale-md touch:btn-enhanced">
                View Full Portfolio
              </button>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 mobile:px-0 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mobile:gap-4 max-w-6xl mx-auto">
              {testimonials.map((testimonial, index) => (
                <div 
                  key={index}
                  className="card-glass p-6 mobile:p-5 hover:scale-105 transition-all duration-300 touch:active-scale-md touch:card-enhanced"
                  data-aos="fade-up"
                  data-aos-delay={100 * index}
                >
                  <div className="text-gold-400 text-4xl mb-3 touch:text-5xl">❝</div>
                  <p className="text-silver-300 mb-5 italic text-sm mobile:text-base touch:text-lg">"{testimonial.quote}"</p>
                  <div className="border-t border-gold-400/20 pt-4">
                    <h4 className="text-base mobile:text-lg font-bold text-ivory touch:text-xl">{testimonial.author}</h4>
                    <p className="text-gold-400 text-xs mobile:text-sm touch:text-base">{testimonial.position}</p>
                  </div>
                </div>
              ))}
            </div>
